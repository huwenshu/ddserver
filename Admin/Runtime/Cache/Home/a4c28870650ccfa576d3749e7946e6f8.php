   ...
   <!-- /边栏 -->
    ...
    <div id="indexMain" class="index-main">
        <ul class="mui-table-view">
            <?php
 foreach ($parks_info as $key => $value) { echo "<li name='moneyitem' class='mui-table-view-cell' alt='".U('parkinfo')."/parkid/".$value['id']."/' ><a class='mui-navigate-right'><p>".$value['name']."</p><p>地址：".$value['address']."</p></a></li>"; } ?>
        </ul>
